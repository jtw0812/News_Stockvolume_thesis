...
stopwords = {
    ...
    "그위에", "그저", "그중에서", "그치지 않다", "근거로", "근거하여", "기대여", "기점으로", "기준으로", "기타",
    ...
    "동안", "된바에야", "된이상", "두번째로", "둘", "둥둥", "뒤따라", "뒤이어", "든간에", "들", "등", "등등",
    "딩동", "따라", "따라서", "따위", "따지지 않다", "딱", "때", "때가 되어", "때문에", "또", "또한", "뚝뚝",
    ...
    "부터", "불구하고", "불문하고", "붕붕", "비걱거리다", "비교적", "비길수 없다", "비로소", "비록", "비슷하다", "비추어 보아",
    ...
    "줄은모른다", "중에서", "중의하나", "즈음하여", "즉", "즉시", "지", "지마", "지마라", "지만", "지말고", "진짜로",
...
def extract_first_element(tokens):
...
def column_tokenize(df, column):
    ...
    df['first_token'] = df['tokens'].apply(extract_first_element)
